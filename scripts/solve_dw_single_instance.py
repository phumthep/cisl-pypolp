...
instance_folder = os.path.join(get_temp_dir(), f"{MODEL_NAME}_24_instances")
...
mip_model = GurobipyOptimizer.create(mip_problem, num_threads=NUM_THREADS)
...
lp_model = GurobipyOptimizer.create(lp_problem, num_threads=NUM_THREADS)
_ = lp_model.optimize()
